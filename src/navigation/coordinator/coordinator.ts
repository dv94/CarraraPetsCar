...
export class Coordinator {
  ...
  static goListCarsScreen() {
    Navigation.navigate(MainStackScreenNames.ListCarsScreen)
  }
  static goDriveProfileScreen() {
    Navigation.navigate(MainStackScreenNames.DriveProfileScreen)
  }
  static goDriveProfileConfigScreen() {
    Navigation.navigate(MainStackScreenNames.DriveProfileConfigScreen)
  }
  static goDriveProfileDocumentScreen() {
    Navigation.navigate(MainStackScreenNames.DriveProfileDocumentScreen)
  }
  static goCreateCar() {
    Navigation.navigate(MainStackScreenNames.CreateCar)
  }
}
