export const MainStackScreenNames = {
  ...
  ListCarsScreen: 'ListCarsScreen',
  DriveProfileScreen: 'DriveProfileScreen',
  DriveProfileConfigScreen: 'DriveProfileConfigScreen',
  DriveProfileDocumentScreen: 'DriveProfileDocumentScreen',
  CreateCar: 'CreateCar',
