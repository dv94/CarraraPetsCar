...
import { ListCarsScreen } from '../../screens/DriveProfileScreen/ListCars/ListCarsScreen'
import { DriveProfileScreen } from '../../screens/DriveProfileScreen/DriveProfileScreen'
import { DriveProfileConfigScreen } from '../../screens/DriveProfileScreen/DriveProfileConfigScreen'
import { DriveProfileDocumentScreen } from '../../screens/DriveProfileScreen/DriveProfileDocumentScreen'
import { CreateCar } from '../../screens/DriveProfileScreen/ListCars/CreateCar'
...
const MainStack = (Stack: any) => [
  ...
  />,
  <Stack.Screen
    key={`${ScreensMainStack}${MainStackScreenNames.ListCarsScreen}`}
    name={MainStackScreenNames.ListCarsScreen}
    component={ListCarsScreen}
  />,
  <Stack.Screen
    key={`${ScreensMainStack}${MainStackScreenNames.DriveProfileScreen}`}
    name={MainStackScreenNames.DriveProfileScreen}
    component={DriveProfileScreen}
  />,
  <Stack.Screen
    key={`${ScreensMainStack}${MainStackScreenNames.DriveProfileConfigScreen}`}
    name={MainStackScreenNames.DriveProfileConfigScreen}
    component={DriveProfileConfigScreen}
  />,
  <Stack.Screen
    key={`${ScreensMainStack}${MainStackScreenNames.DriveProfileDocumentScreen}`}
    name={MainStackScreenNames.DriveProfileDocumentScreen}
    component={DriveProfileDocumentScreen}
  />,
  <Stack.Screen
    key={`${ScreensMainStack}${MainStackScreenNames.CreateCar}`}
    name={MainStackScreenNames.CreateCar}
    component={CreateCar}
  />,
